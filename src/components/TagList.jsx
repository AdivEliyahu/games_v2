  ...
  return (
    <div className="flex flex-wrap gap-2">
      {tags.map((tag) => (
        <span
          key={tag}
          className="flex items-center text-sm text-neon-green bg-gray-900 border border-neon-green rounded-full px-2 py-1"
        >
          #{tag}
          {editable && (
            <button
      ...
      {editable && (
        <input
          type="text"
          className="bg-transparent outline-none border-b border-neon-green text-neon-green w-20"
          value={input}
